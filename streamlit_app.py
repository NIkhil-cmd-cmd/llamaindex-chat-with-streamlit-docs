...
st.set_page_config(page_title="Chat with the Mental Health Assistant, powered by LlamaIndex", page_icon="🧠", layout="centered", initial_sidebar_state="auto", menu_items=None)
